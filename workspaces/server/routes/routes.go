...
func Controller() {
	...
	s.HandleFunc("/getUserDetails", handlers.GetUserDetails).Methods("POST")
	s.HandleFunc("/updateMobile", handlers.UpdateUserMobile).Methods("POST")
	s.HandleFunc("/getBookings", handlers.GetBookings).Methods("POST")
	cors(s)
